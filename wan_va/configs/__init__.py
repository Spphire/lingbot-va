...
from .va_nmx_chip_train_cfg import (
    ...
    va_nmx_gift_box_train_fastwam_cfg,
    va_nmx_chip_train_fastwam_cfg,
    va_nmx_chip_train_mot_cfg,
    va_nmx_chip_train_mot_fastwam_cfg,
    va_nmx_chip_train_mot_idm_cfg,
    va_nmx_chip_train_mot_per_view_pad_idm_cfg,
    va_nmx_chip_train_mot_per_view_pad_fastwam_cfg,
...
VA_CONFIGS = {
    ...
    'nmx_chip_train_mot_fastwam': va_nmx_chip_train_mot_fastwam_cfg,
    'nmx_chip_train_mot_idm': va_nmx_chip_train_mot_idm_cfg,
    'nmx_chip_train_mot_per_view_pad_idm': va_nmx_chip_train_mot_per_view_pad_idm_cfg,
    'nmx_chip_train_mot_per_view_pad_fastwam': va_nmx_chip_train_mot_per_view_pad_fastwam_cfg,
    ...
    'nmx_gift_box_train_fastwam': va_nmx_gift_box_train_fastwam_cfg,
